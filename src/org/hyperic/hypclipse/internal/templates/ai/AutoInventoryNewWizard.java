...
public class AutoInventoryNewWizard extends NewPluginTemplateWizard {

	public AutoInventoryNewWizard() {
		super();
	}

	public void init(IFieldData data) {
		super.init(data);
		setWindowTitle(HQDEMessages.AutoInventoryNewWizard_wtitle);
	}
	...
	public ITemplateSection[] createTemplateSections() {
		return new ITemplateSection[] {new AutoInventoryTemplate(), new BasicProcessMetricsTemplate()};
	}
}
