...
public abstract class BaseOptionTemplateSection extends AbstractTemplateSection {
	...
	/**
	 * Initializes options in the wizard page using the one of selected
	 * model objects. This is usually selected object by user. This way 
	 * template is able to do actions agains this and not just the against
	 * base node.
	 * 
	 * @param model
	 */
