...
public class ElementCollector implements ExpressionVisitorVoid {
...
//	private ExpressionPool pool = new ExpressionPool();
	...
	public final void collect(Expression exp, Collection<ElementExp> result) {
		this.result = result;
		exp.visit(this);
	}
...
//    	System.out.print("@"+exp.getNameClass().toString() +" ");
    	result.add(exp);
    }
...
//    	System.out.print("@"+exp.nameClass.toString()+" ");
//    	result.add(exp);
//        exp.exp.visit(this);
    }
