...
/**
 * Collects wrapped annotation attributes.
 */
public class AnnotationCollector implements ExpressionVisitorVoid {
	...
	public final void collect(Expression exp, Collection<AttributeExp> result) {
		this.result = result;
		exp.visit(this);
	}
...
//        exp.visit(this);
    ...
    public void onAttribute( AttributeExp exp ) {
    	if(exp.exp instanceof AnnotationExp) {
    		result.add(exp);
    	}
        exp.exp.visit(this);
    }
