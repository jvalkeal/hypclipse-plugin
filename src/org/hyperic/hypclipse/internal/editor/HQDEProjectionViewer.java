 ...
 *
 */
public class HQDEProjectionViewer extends ProjectionViewer {
	 ...
	 * @param styles
	 */
	public HQDEProjectionViewer(Composite parent, IVerticalRuler ruler, IOverviewRuler overviewRuler, boolean showsAnnotationOverview, int styles, boolean isQuickOutlineEnabled) {
