...
public class WorkspaceBuildModelFactory implements IBuildModelFactory {

	private IBuildModel fModel;

	public WorkspaceBuildModelFactory(IBuildModel model) {
		fModel = model;
	}

	public IBuildEntry createEntry(String name) {
		WorkspaceBuildEntry entry =  new WorkspaceBuildEntry(name);
