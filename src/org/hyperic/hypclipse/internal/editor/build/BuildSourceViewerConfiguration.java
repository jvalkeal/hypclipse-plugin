...
import org.hyperic.hypclipse.internal.text.ArgumentRule;
import org.hyperic.hypclipse.internal.text.BaseHQDEScanner;
...
public class BuildSourceViewerConfiguration extends ChangeAwareSourceViewerConfiguration {
	...
	private BaseHQDEScanner fPropertyKeyScanner;
	private BaseHQDEScanner fCommentScanner;
	private BaseHQDEScanner fPropertyValueScanner;

//	private HQDEQuickAssistAssistant fQuickAssistant;

	private abstract class AbstractJavaScanner extends BaseHQDEScanner {
	...
	public BuildSourceViewerConfiguration(IColorManager colorManager, IPreferenceStore store, HQDESourcePage sourcePage) {
