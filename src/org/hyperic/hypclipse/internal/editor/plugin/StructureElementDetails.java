 ...
 *
 */
public class StructureElementDetails extends AbstractPluginElementDetails {
	private IPluginElement input;
	private ArrayList<StructureAttributeRow> rows;
	private Section section;
	private PluginElementNode structureElement;

	/**
	 * @param masterSection
	 * @param schemaElement
	 */
	public StructureElementDetails(HQDESection masterSection, PluginElementNode structureElement) {
		super(masterSection);
	...
	public void createContents(Composite parent) {
		...
		if(structureElement != null) {
			...
			IPluginAttribute atts[] = structureElement.getAttributes();
...
//			Expression eExp = exp.contentModel.getExpandedExp(pool);
	...
	/**
	 * Since we don't always know if expression is encapsulated
	 * within annonation, this function automatically unwraps it.
	 */
