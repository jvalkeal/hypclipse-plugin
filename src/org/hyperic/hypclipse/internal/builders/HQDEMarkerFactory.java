...
public class HQDEMarkerFactory implements IMarkerFactory {

	public static final String MARKER_ID = "org.hyperic.hypclipse.problem"; //$NON-NLS-1$
	...
	/*
	 * (non-Javadoc)
	 * @see org.hyperic.hypclipse.internal.builders.IMarkerFactory#createMarker(org.eclipse.core.resources.IFile)
	 */
